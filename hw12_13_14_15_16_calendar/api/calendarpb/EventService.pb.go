...
const file_EventService_proto_rawDesc = "" +
	"\n" +
	"\x12EventService.proto\x12\x05event\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd0\x01\n" +
	"\x05Event\x12\x17\n" +
	...
	"\x10GetEventsByMonth\x12\x12.event.DateRequest\x1a\x15.event.EventsResponseB&Z$mycalendar/api/calendarpb;calendarpbb\x06proto3"
