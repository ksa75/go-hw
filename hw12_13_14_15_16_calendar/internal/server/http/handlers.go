...
func (s *Server) createEventHandler(w http.ResponseWriter, r *http.Request) {
	...
	err := s.app.CreateEvent(r.Context(), req.UserID, req.Title, req.Description, req.Duration, req.NoticeBefore, req.StartAt)
	if err != nil {
...
func (s *Server) updateEventHandler(w http.ResponseWriter, r *http.Request) {
	...
	err := s.app.UpdateEvent(r.Context(), req.UserID, req.Title, req.Description, req.Duration, req.NoticeBefore, req.StartAt)
	if err != nil {
